...
export function calculateBurnRate(input) {
    ...
    // Context burn rate
    let contextRatePerMin = null;
    let contextEtaMinutes = null;
    if (contextPercent > 0) {
    ...
    let tokenRatePerMin = null;
    let recentTokenRatePerMin = null;
    ...
    // Usage burn rate
    let fiveHourRatePerMin = null;
    let fiveHourEtaMinutes = null;
